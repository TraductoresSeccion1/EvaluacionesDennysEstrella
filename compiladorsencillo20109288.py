# El ejemplo del programa que hace de calculadora es el “Hola Mundo” de los generadores de analizadores sintácticos. 
# A continuación se pone un ejemplo de calculadora que procesa expresiones matemáticas. Simplemente se introducen las 
# expresiones matemáticas, como 1+3.2*5^2 y el programa mostrará el resultado por pantalla (así como las reglas de
# análisis de las operaciones). El programa terminará cuando introduzcamos una entrada vacía. (Compilador de BASIC de ZX Spectrum)

# Integrante: DENNYS ESTRELLA CI 20.109.288 Traductores e Interpretes. Seccion:1
